...
class Agent {
	...
	public Agent(Environment world, TransferPercept perceptTrans, boolean nonDeterministic, int heuristic, int ms) {
		...
		wumpusWorld = world;
		agentFunction = new AgentFunction(world, wumpusWorld.getWorldSize(), heuristic, ms);
	...
	public int chooseAction() {
		return agentFunction.process(percept, direction);
	}
